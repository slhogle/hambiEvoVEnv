...
This notebook estimates growth rates by fitting non-parametric splines using the really nice [`growthrates`](https://github.com/tpetzoldt/growthrates) package. AUC is esimated using the [`DescTools`](https://andrisignorell.github.io/DescTools/) package.
...
#| warning: false
#| error: false
gcurves_thin_sm <- readr::read_tsv(here::here(data_stp_cl, "gcurves_smoothed_thinned.tsv"))
```
...
#| echo: false
#| warning: false
many_spline <- readr::read_rds(here::here(data_stp_cl, "spline_fits"))
```
...
many_spline_res %>% 
  ...
  readr::write_tsv(here::here(data_stp_cl, "auc_mumax_results.tsv"))
```
