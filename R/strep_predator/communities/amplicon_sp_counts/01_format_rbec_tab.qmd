...
Parition out the two different projects (tipping points and pleiotropy were sequenced on same flow cell) 
...
```{r}
readr:::write_tsv(finalpleio, here::here(data_stp_sp, "species_counts_md.tsv"))

readr::write_tsv(finaltip, here::here(data_stp_sp, "species_counts_md_tippingpoints.tsv"))
```
